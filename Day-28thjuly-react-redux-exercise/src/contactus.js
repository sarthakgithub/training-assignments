    ...
    render() {
        return (
            <form className="ContactUs" onSubmit={this.handleSubmit}>
                ...
                <input type="text" name="firstname"  className="form-control" value={this.state.value1} onChange={this.handleChangeFirst} required />
                <label >Lastname</label>
                <input type="text" name="lastname"  className="form-control" value={this.state.value2} onChange={this.handleChangeSecond} required/>
